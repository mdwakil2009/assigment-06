...
const WorkoutDetailsPage = async ({
  ...
  <div className="flex flex-col ">
    ...
    <h1 className={`${oswald.className}text-3xl md:text-4xl font-semibold uppercase text-white mt-4 mb-3`}>
      {library.name}
    </h1>
    ...
    <div className="mb-6 text-white">
      <h2 className={`${oswald.className}text-2xl font-semibold uppercase mb-4`}>
        INSTRUCTIONS
      </h2>
    ...
    <div className="flex flex-col sm:flex-row gap-4 mt-auto">
      <button className=" flex items-center justify-center gap-2 bg-[#C2F800] text-black font-bold px-4 py-2 rounded-xl hover:bg-[#222630 cursor-pointer  ">
        <LuCalendarPlus2 />

        Add to today's plan
      </button>

      <button className="flex items-center justify-center gap-2 border border-gray-600 px-4 py-2 rounded-xl font-bold hover:bg-[#222630] text-white cursor-pointer ">
        <FaBookmark />
        Save for later
      </button>
    </div>
