    ...
    <div className="bg-black text-white">
      <nav className="container mx-auto flex justify-between items-center py-6">
        ...
        <div className="flex  justify-center gap-10">
          <Link href="">Plan <span className=" border border-1 rounded-full px-1 items-center  ">0</span> </Link>
          <Link href="">Saved <span className=" border border-1 rounded-full px-1 items-center  ">0</span>  </Link>
        </div>
      </nav>
    </div>
  );
